...
export const MOLECULE_IMAGE_ENDPOINT = 'https://smilestoimg.herokuapp.com/api/dev/smiles';
// export const MOLECULE_IMAGE_ENDPOINT = 'http://127.0.0.1:8000/api/dev/smiles';
